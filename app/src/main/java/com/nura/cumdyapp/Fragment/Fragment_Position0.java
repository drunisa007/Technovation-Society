...
public class Fragment_Position0 extends Fragment {
    ...
    private DatabaseReference mdRef= FirebaseDatabase.getInstance().getReference().child("wholekings");

    public Fragment_Position0() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v=inflater.inflate(R.layout.fragment_fragment__position0, container, false);
    ...
    private void savingData(DataSnapshot dataSnapshot) {
        ...
        mRecyclerview.setAdapter(new MyResultRecycler_Adapter(mList,"wholekingscounts"));
    }
    ...
    private void givingId(View v) {
        ...
        mRecyclerview=v.findViewById(R.id.result_recyclerview);
