...
public class Fragment_Position1 extends Fragment {

    private RecyclerView mRecyclerview;

    private  List<Voting_Result> mList=new ArrayList<>();

    private DatabaseReference mdRef= FirebaseDatabase.getInstance().getReference().child("wholequeens");



    public Fragment_Position1() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       View v= inflater.inflate(R.layout.fragment_fragment__position1, container, false);
    ...
    private void savingData(DataSnapshot dataSnapshot) {
        ...
        mRecyclerview.setAdapter(new MyResultRecycler_Adapter(mList,"wholequeenscounts"));    }



    private void givingId(View v) {

        mRecyclerview=v.findViewById(R.id.result_recyclerviewone);
